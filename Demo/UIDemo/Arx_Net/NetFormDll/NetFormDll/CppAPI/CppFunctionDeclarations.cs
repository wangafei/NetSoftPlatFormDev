...
namespace NetFormDll.CppAPI
{
    ...
    public delegate int DoModal(IntPtr hWnd);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void BeginEditorCommand(IntPtr hWnd);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void CancelEditorCommand(IntPtr hWnd);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void CompleteEditorCommand(IntPtr hWnd, bool restoreDialogs);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void MoveViewInModalDlg();
    //     [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
